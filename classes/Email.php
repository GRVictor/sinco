...
class Email {
    ...
    public function sendEmail() {
        ...
        $content .= "<p><a href='" . $_ENV['APP_URL'] . "/confirm?token=" . $this->token . "'>Confirmar cuenta</a></p>";
        $content .= "</html>";
    ...
    public function sendPasswordReset() {
        ...
        $content .= "<p><a href='" . $_ENV['APP_URL'] . "/reset?token=" . $this->token . "'>Restablecer contraseña</a></p>";
